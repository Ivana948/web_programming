...
@Component //bez ova Spring ne ja gleda klasata i initData() nikogas nema da se povika
public class DataInitializer {
    ...
    @PostConstruct //ova kazuva da se povika ovoj metod otkako Spring kje ja kreira klasata
